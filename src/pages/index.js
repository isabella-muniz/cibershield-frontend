        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="space-x-4">
            ...
            <button
              ...
              className="px-6 py-2 border-2 border-green-500 text-blue-500 hover:bg-green-500 hover:text-white rounded-lg transition-all duration-300 transform hover:scale-105"
            >
              Registro
            </button>
          </div>
